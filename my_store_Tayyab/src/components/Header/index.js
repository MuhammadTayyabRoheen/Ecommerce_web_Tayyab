...
const Header = () => {
  return (
    <header style={{backgroundColor:'#172554'}} className="text-gray-600 body-font shadow-lg">
        ...
        <nav className="md:ml-auto md:mr-auto flex flex-wrap items-center text-base justify-center">
          {
            navigations.map((navigation) => {
              return (
                <Link to={navigation.path} className="mr-5 hover:text-white">{navigation.name}</Link>
              )
            })
          }
        </nav>
